...
Noble.prototype.spoofPeripheral = function(address, addressType, connectable, advertisement, rssi) {
  if (typeof this._bindings.spoofPeripheral === 'function') {
    this._bindings.spoofPeripheral(address, addressType, connectable, advertisement, rssi);
  }

  var uuid = address.split(':').join('');
  var peripheral = new Peripheral(this, uuid, address, addressType, connectable, advertisement, rssi);
...
Noble.prototype.connect = function(peripheralUuid, options) {
  this._bindings.connect(peripheralUuid, options);
};
